...
$result = $SOEXBD->query("SELECT * FROM EMPLEADOS ");
?>
...
<tr class="bg-primary">
	...
	while($row = $result->fetch(PDO::FETCH_ASSOC)) { 		
		echo "<tr>";
		echo "<td><h4>".$row['DocEmpleado']."</h4></td>";
		echo "<td><h4>".$row['Nombre']."</h4></td>";
		echo "<td><h4>".$row['Apellido']."</h4></td>";	
		echo "<td><h4>".$row['Direccion']."</h4></td>";	
		echo "<td><a href=\"edit.php?id=$row[DocEmpleado]\">EDITAR</a> | <a href=\"delete.php?id=$row[DocEmpleado]\" onClick=\"return confirm('Seguro que quieres eliminar este Empleado?')\">ELIMINAR</a></h4></td>";		
	}
	?>
	</table>
        </div>
